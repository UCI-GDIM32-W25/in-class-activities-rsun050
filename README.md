...
### Activity 1
code scaling<br>
how to know if your code works well, not just works?<br>
- when program handles lots of data:
  - performant
  - easy for users (whether programmers/designers/writers/artists/etc) to add/edit/delete data

why should scaling matter for you:
- easier for YOU to make your game as the game grows

building scaling code: programming design patterns!
- state machines
- mvc
